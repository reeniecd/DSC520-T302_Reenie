...
person_df2 <- read.csv(file = 'C:/Users/chris/dsc520/data/tidynomicon/person.csv', stringsAsFactors =FALSE)
str(person_df2)
```
...
scores_df <- read.csv(file = 'C:/Users/chris/dsc520/data/scores.csv', stringsAsFactors =FALSE)
summary(scores_df)
```
...
sheet_names <- excel_sheets("C:/Users/chris/dsc520/data/G04ResultsDetail2004-11-02.xls")  
sheet_names
```
...
voter_turnout_df1 <- read_excel("C:/Users/chris/dsc520/data/G04ResultsDetail2004-11-02.xls", sheet="Voter Turnout", skip = 1)
...
voter_turnout_df2 <- read_excel("C:/Users/chris/dsc520/data/G04ResultsDetail2004-11-02.xls", sheet="Voter Turnout", skip = 2, col_names = c("ward_precint", "ballots_cast", "registered_voters", "voter_turnout"))
#voter_turnout_df2 <- c( "ward_precint", "ballots_cast", "registered_voters", "voter_turnout")
str(voter_turnout_df1)
```
...
##library(RSQLite)
db <- dbConnect(RSQLite::SQLite(), 'C:/Users/chris/dsc520/data/tidynomicon/example.db')
